...
namespace Anteproyecto.Aplication.Test
{
    public class ProyectoInMemoryTest
    {
        ...
        public void ValidarResumenInMemoryTest()
        {
            ...
            var proyecto = new Proyecto("Aplicativo Web Para la Gesti�n, seguimiento y evaluaci�n de los anteproyectos del programa de Psicolog�a de la Universidad Popular del Cesar", "El aplicativo web a desarrollar tiene como objetivo ser una herramienta que permita gestionar y controlar de manera adecuada el seguimiento de los anteproyectos recibidos en la oficina de psicolog�a en la Universidad Popular del Cesar, ubicada en la ciudad de Valledupar. Para esto se requiere que el sistema pueda");
