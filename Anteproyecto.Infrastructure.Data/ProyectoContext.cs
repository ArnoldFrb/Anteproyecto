    ...
    public class ProyectoContext : DbContextBase
    {
        ...
        protected void SemillasUsuario(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Estudiante>().HasData(
                    ...
                    new { Id = 2, Nombres = "Andres alejandro", Apellidos = "Santander Pimienta", NumeroIdentificacion = "1222222231", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 9, Edad = 23, Estado = false},
