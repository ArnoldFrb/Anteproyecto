    ...
    public class ProyectoContext : DbContextBase
    {
        ...
        protected void SemillasUsuario(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Estudiante>().HasData(
                    new { Id = 1, Nombres = "Jose Carlo", Apellidos = "Santander Pimienta", NumeroIdentificacion = "1222222212", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 5, Edad = 13, Estado = false},
                    new { Id = 2, Nombres = "Andres alejandro", Apellidos = "espinosa Pimienta", NumeroIdentificacion = "1222222231", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 2, Edad = 13, Estado = false},
                    new { Id = 3, Nombres = "Pedro pepi", Apellidos = "romulo salamandra", NumeroIdentificacion = "1222222246", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 5, Edad = 43, Estado = true },
                    new { Id = 4, Nombres = "rodoldo pepi", Apellidos = "papeleta Piña", NumeroIdentificacion = "3556222246", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 4, Edad = 53, Estado = true },
                    new { Id = 5, Nombres = "san francisco", Apellidos = "pepe de la hoz", NumeroIdentificacion = "2346222246", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 3, Edad = 33, Estado = true }
           );


            modelBuilder.Entity<MiembroComite>().HasData(
                   new { Id = 6, Nombres = "Santiago ramirez", Apellidos = "Santander Pimienta", NumeroIdentificacion = "2222233233", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 9, Edad = 23, Estado = false },
            ...
            modelBuilder.Entity<AsesorMetodologico>().HasData(
              ...
              new { Id = 10, Nombres = "velen lopez", Apellidos = "Santander Pimienta", NumeroIdentificacion = "3222233200", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 9, Edad = 23, Estado = true },
              new { Id = 11, Nombres = "rico rico domingo", Apellidos = "Santander Pimienta", NumeroIdentificacion = "3222233012", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 9, Edad = 23, Estado = true }

                );

            modelBuilder.Entity<AsesorTematico>().HasData(
            new { Id = 12, Nombres = "pedro ramirez", Apellidos = "Santander Pimienta", NumeroIdentificacion = "5222232229", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 9, Edad = 23, Estado = false},
            new { Id = 13, Nombres = "reminro lopez", Apellidos = "Santander Pimienta", NumeroIdentificacion = "5222221200", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 9, Edad = 23, Estado = true },
            new { Id = 14, Nombres = "osvaldo  domingo", Apellidos = "Santander Pimienta", NumeroIdentificacion = "5211233012", Correo = "hola@gmail.com", Contraseña = "123344444", Semestre = 9, Edad = 23, Estado = true }
              );
        }
