...
namespace Anteproyecto.Infrastructure.Data.Migrations
{
    ...
    [Migration("20210701162709_InitialCreate")]
            ...
            modelBuilder.Entity("Anteproyecto.Domain.Entities.Observacion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Comentario = "holaa mudnooo aqui",
                            Date = new DateTime(2021, 7, 1, 11, 27, 8, 737, DateTimeKind.Local).AddTicks(4795),
                            Nombre = "Correccion de objetivos",
                            ProyectoId = 1
                        });
                });
            ...
            modelBuilder.Entity("Anteproyecto.Domain.Entities.Proyecto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AsesorTematicoId = 12,
                            Cut = 2,
                            Date = new DateTime(2021, 7, 1, 11, 27, 8, 735, DateTimeKind.Local).AddTicks(4830),
                            Estudiante1Id = 1,
                            Estudiante2Id = 2,
                            Focus = "arriva",
                            Line = "investigacion",
